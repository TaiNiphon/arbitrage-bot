    ...
    def _report_manager(self, price, pnl, ema, rsi, adx):
        try:
            ...
            report = (
                ...
                f"📈 EMA: {ema:,.2f} ({ema_diff:+.2f}%)\n"
                f"🕒 Net P/L: {pnl:+.2f}%\n"
                f"🔭 1H Trend: <b>{trend_label}</b>\n"
