...
class BitkubUltimateV8_7_3_TITAN:
        ...
        while True:
            try:
                ...
                # --- 🟢 SELL LOGIC ---
                    ...
                    elif pnl >= self.breakeven_pct and price <= (self.avg_price * 1.0025): reason = "Breakeven Protected"
    ...
    def _report_manager(self, price, pnl, ema, rsi, adx, slope, thb, coin):
        try:
            ...
            be_price = self.avg_price * 1.0025 if self.avg_price > 0 else 0
            ...
            report = (
                ...
                f"📉 BreakEven @: {be_price:,.2f}\n"
                f"🛡️ Trailing @: {self.dynamic_sl:,.2f}\n"
                f"🔭 Trend: {self.big_trend}\n{div}\n"
                f"🏛️ <b>PORTFOLIO</b>\n"
                f"💵 Cash: {thb:,.2f} THB\n"
    ...
    def _request(self, method, path, params=None, payload=None, private=False):
        ...
        if private:
            ...
            except: return {"error": 1, "msg": "API Time Error"}
        ...
        if os.path.exists(self.state_file):
            try:
                with open(self.state_file, "r") as f: 
                    ...
                    self.total_units = d.get('units', 0.0)
            except: pass
